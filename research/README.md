...
Long-form research reports. These are **findings**, not reference material —
they record what was true when the work was done, and they are not maintained
the way `skills/mongol-bichig/references/` is. Read them for the reasoning and
the sources; trust the references for the facts.

| Report | Date | What it establishes |
|---|---|---|
