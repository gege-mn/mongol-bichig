...
| Bolorsoft **Tungaamal** | Win/macOS/Linux/web | NNBSP (docs) | Mongolia's dominant keyboard (3.7M+ downloads claimed). Ships Bolorsoft's "refined phonetic model" — **confirmed NOT UTN #57** (Teneg 2025 fn 3); its "approved by Unicode experts" marketing was denied by three UTC members (fn 24) |
...
Bolorsoft formally proposed separate KE/GE letters (L2/18-294, 2018, with a
...
mngl.net keyboard. The project's own hb-view-verified look-alike finding and
