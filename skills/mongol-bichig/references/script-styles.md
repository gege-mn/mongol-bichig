...
|---|---|---|
| U+1888 ALI GALI I | ᠬ QA U+182C | this project's hb-view-verified finding; real keyboards emit it (externally unpublished — likely chain: Bolorsoft's rejected KE/GE proposal L2/18-294 → Tungaamal's separate He/Ge keys; unconfirmed) |
